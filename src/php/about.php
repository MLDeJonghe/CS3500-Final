...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <p class="display-3">About The Developers</h1>
            ...
            <div class="col">
                <div class="row">
                    <div class="col-md-6 text-center">
                        <img src="../images/pic.jpg" alt="Avatar" style="width:300px;height:300px;" class="rounded-circle border-primary" data-aos="zoom-in">
                        <h1>Darryl</h1>
                        ...
                        <div class="descrip" data-aos="fade-right">
                    ...
                    <div class="col-md-6 text-center">
                        ...
                        <a href="https://github.com/Gandlfer"><img src="..\images\GitHub-Mark-120px-plus.png" class="github" width=25px height=25px></a>
                        <div class="descrip" data-aos="fade-left">
