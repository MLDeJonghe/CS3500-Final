                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        if ($row['dishID'] < 200) {
                            ...
                            echo '<p id="item" class="font-weight-bold">' . $row['item'] . '</p>
                                ...
                                <button class="btn btn-primary text-nowrap">Add to Order</button>
                                </div>
                                </div>
                                </li>
                                ';
                ...
                <ul class="list-group list-group-flush">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        if ($row['dishID'] < 300 && $row['dishID'] >= 200) {
                            ...
                            <div class="col-sm-6"><p>' . $row['itemDescription'] . '</p></div>
                            <div id="price" class="col-sm-1"><p>$' . $row['itemPrice'] . '</p></div>
                            <div class="col-sm-2 ml-2 float-right" ><button class="btn btn-primary text-nowrap">Add to Order</button></div>
                            </div>
                            </li>
                            ';
                        }
