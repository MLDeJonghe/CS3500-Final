...
<body>
    ...
    <div class="container">
        <br>
        <h1 class="text-uppercase">Order Online</h1>
        <br>
        <div class="row justify-content-between">
            <div class="col-md-10 border border-muted rounded shadow-sm ml-auto">
                <br>

                <form id="orderForm" method="post" onsubmit="return validateInfo();" action="http://www.randyconnolly.com/tests/process.php">
