        ...
        <div class="row border">
            <div class="col-sm-10">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id=-KZ-tab" data-toggle="tab" href="-KZ" role="tab" aria-controls=-KZ" aria-selected="true"-KZ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="GR-tab" data-toggle="tab" href="#GR" role="tab" aria-controls="GR" aria-selected="false">GR</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id=-KZ" role="tabpanel" aria-labelledby=-KZ-tab">
